...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b37606ea", Component.options)
  } else {
    hotAPI.reload("data-v-b37606ea", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        deleteMusic: function deleteMusic(id) {
            var self = this;
            console.log(id);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b37606ea", module.exports)
  }
}
